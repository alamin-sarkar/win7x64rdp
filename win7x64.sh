...
echo "===================================="
wget -O w7x64.img https://archivist.vagrantup.com/v1/object/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJrZXkiOiJib3hlcy82MDlhZDdhOC02YWE0LTRjMjctYTExNC1jMTk4MDYxNzVkZDciLCJtb2RlIjoiciIsImV4cGlyZSI6MTY0MjcwMTQ3MH0.iZvbNSOakCecbKmGaxro58I-SQPTvcysCGb5W25l3Ak
echo "===================================="
echo "Download ngrok"
echo "===================================="
